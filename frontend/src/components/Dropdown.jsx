    ...
    <Menu as="div" className="relative inline-block">
      ...
      >
        <div className="py-1">
          ...
          <MenuItem>
            <NavLink
                onClick={handleLogout} to='/login' className="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden"
            >
              Logout
            </NavLink>
          </MenuItem>
