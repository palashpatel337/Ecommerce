...
export const Spinner = ({path='login'}) => {
  ...
  return (
    ...
    <div className='h-[100%] w-[100%] '>
        <div className=' mt-[30vh] justify-items-center'>
            <h1 className='text-2xl'>Redirecting to you in {count} seconds</h1>
            <div role="status" className='mt-4 '>
                <svg aria-hidden="true" className="w-9 h-9 text-gray-200 animate-spin dark:text-gray-200 fill-zinc-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 
