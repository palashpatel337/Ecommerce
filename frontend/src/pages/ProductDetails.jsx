...
const ProductDetails = () => {
    ...
    <Layout>
      <div className="grid grid-cols-8 flex border-b-2 border-zinc-200 pb-10">
        ...
        <div className="col-span-3 m-5 ">
            ...
            <h1 className="flex">Price: <LiaRupeeSignSolid /> {product?.price}</h1>
 ...
 type="primary">Add to Cart</Button>
      ...
      <div className=" mx-10 my-5 text-2xl">
        ...
        {related.length < 1 && (<p className="text-center text-xl">No similar products found</p>)}
            {related?.map((p) => (
              <Link
                key={p._id}
                to={`/product/${p.slug}`}
              ...
              >
                <div className="m-5 ">
                  <Card
                    ...
                    actions={[
                      <Button onClick={() => navigate(`/product/${p.slug}`)} type="">More Details</Button>,
                      <Button onClick={() => navigate(``)} type="ghost">Add to Cart</Button>,
                    ]}
                  >
